...
{   
    ...
    public virtual DbSet<CustomerInitial> CustomerInitials { get; set; }

    public virtual DbSet<CustomerIntial> CustomerIntials { get; set; }
...
// warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomerInitial>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CustomerInitials");

            entity.Property(e => e.FirstName).HasMaxLength(40);
            entity.Property(e => e.Initials).HasMaxLength(2);
            entity.Property(e => e.LastName).HasMaxLength(20);
        });

        modelBuilder.Entity<CustomerIntial>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CustomerIntials");
